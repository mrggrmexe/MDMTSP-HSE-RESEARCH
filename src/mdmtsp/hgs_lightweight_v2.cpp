...
[[nodiscard]] MDMTSPSolution solve_mdmtsp_hgs_lightweight_v2(
    ...
    if (population.empty()) {
        throw std::logic_error("solve_mdmtsp_hgs_lightweight_v2: empty initial population");
    }
    ...
    if (!best_solution.has_value()) {
        throw std::logic_error("solve_mdmtsp_hgs_lightweight_v2: failed to build any candidate");
    }
